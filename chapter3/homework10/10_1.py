...
class BILLIARD(object):
    def __init__(self,_alpha=0.,_r=1.,_x0=0.2,_y0=0.,_vx0=0.6,_vy0=0.8,_dt=0.02,_time=300):
...
ax1.set_ylabel(r'$y (m)$',fontsize=15)
ax1.set_title('Circular stadium: trajectory',fontsize=15)
ax2.set_xlabel(r'$x (m)$',fontsize=15)
ax2.set_ylabel(r'$v_x (m/s)$',fontsize=15)
ax2.set_title('Circular stadium: phase-space',fontsize=15)
ax3.set_xlabel(r'$x (m)$',fontsize=15)
ax3.set_ylabel(r'$y (m)$',fontsize=15)
ax3.set_title('Billiard'+r'$\alpha=0.05$'+': trajectory',fontsize=15)
ax4.set_xlabel(r'$x (m)$',fontsize=15)
ax4.set_ylabel(r'$v_x (m/s)$',fontsize=15)
ax4.set_title('Billiard '+r'$\alpha=0.05$'+': phase-space',fontsize=15)
cmp=BILLIARD()
cmp.cal()
